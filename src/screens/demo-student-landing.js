                            ...
                            <Card className={classes.card}>
                                <CardContent>
                                    ...
                                    <Typography component="p">
                                        Turn in an assignment for one of the
                    ...
                    <Grid className={classes.gridElem} item md={2}>
                        <div>
                            <Card className={classes.card}>
                                ...
                                <CardActions>
                                    <Button onClick={this.navToPostNews.bind(this)} size="small">See News</Button>
                                </CardActions>
                                </Card>
                            </div>
                    </Grid>
                        ...
                        <div>
                            <Card className={classes.card}>
                                <CardContent>
                                    ...
                                    <Typography component="p">
                                        Check the number of attendances you have for each class.
                                    </Typography>
                                   </CardContent>
                                <CardActions>
                                    <Button size="small">See Attendance Sheet</Button>
                                </CardActions>
                            </Card>
                        </div>
                    </Grid>
                            ...
                            <div>
                                <Card className={classes.card}>
                                    <CardContent>
                                        ...
                                        <Typography component="p">
                                            Visualize mandatory and optional classes you are 
                                            enrolled in.
                                        </Typography>
                                    </CardContent>
                                    <CardActions>
                                        <Button onClick={this.navToEnroll.bind(this)} size="small">View Subjects</Button>
                                    </CardActions>
                                </Card>
                            </div>
                    </Grid>
